...
{	
	...
	public void test_See_Two_Cards()
	{
		...
		assertEquals(true, player_0.default_hand.show_cards(2));
	}
	...
	public void test_see_One_Card()
	{
		...
		assertEquals(true, dealer_0.default_hand.show_cards(1));
	}
	...
	public void test_Player_Stand()
	{
		...
		assertEquals(true, player_0.hit_or_stand(deck_1, player_0.default_hand));
	}
	...
	public void test_Display_Player_Hand_End()
	{
		...
		assertEquals(true, player_0.default_hand.show_cards(player_0.default_hand.cards.size()));
	}
	...
	public void test_Player_Bust()
	{
		...
		assertEquals(true, player_0.default_hand.bust());
	}
	...
	public void test_Dealer_16()
	{
		...
		assertEquals(false, dealer_0.dealer_turn(deck_1, player_0, dealer_0.default_hand));
	}
	...
	public void test_Dealer_Repeat_Hit()
	{
		...
		dealer_0.default_hand.add(four_h);
	...
	public void test_Display_Dealer_Hand_End()
	{
		...
		assertEquals(true, dealer_0.default_hand.show_cards(dealer_0.default_hand.cards.size()));
	}
...
//		assertEquals(true, dealer_1.win);
	...
	public void test_Player_Score()
	{
		...
		assertEquals(true, player_0.default_hand.show_score());
	}
	...
	public void test_Dealer_Score()
	{
		...
		assertEquals(true, dealer_0.default_hand.show_score());
	}
...
//		assertEquals(false, player_0.win);
	...
	public void test_Player_Split()
	{
		...
		player_0.choose_split();
		dealer_0.choose_split();
